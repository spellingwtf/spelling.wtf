...
function v2.Create(p18)
	...
	p18.jumpButton.Name = "RunButton";
	p18.jumpButton.Visible = false;
	p18.jumpButton.BackgroundTransparency = 1;
	p18.jumpButton.Image = "rbxassetid://3039332099";
	p18.jumpButton.Size = UDim2.new(0, v8, 0, v8);
	p18.jumpButton.AnchorPoint = Vector2.new(0.75, 0);
	p18.jumpButton.Position = v6 and UDim2.new(1, -v8 - 20 - v8, 1, -v8 - 20 - v8 / 4) or UDim2.new(1, -(v8 * 1.5) - 20 - v8, 1, -v8 * 1.75 - v8 / 4);
	local u3 = nil;
	p18.jumpButton.InputBegan:connect(function(p19)
		...
		print(_G.ToggleRun);
		if not _G.ToggleRun then
			u3 = p19;
			_G.PlayerRunning = true;
			game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 24;
			p18.jumpButton.Image = "rbxassetid://3052584180";
			_G.ToggleRun = true;
			return;
		end;
		if _G.ToggleRun == true then
			_G.ToggleRun = nil;
			u3 = nil;
			game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 16;
			_G.PlayerRunning = nil;
			p18.jumpButton.Image = "rbxassetid://3039332099";
		end;
	end);
	local function u4()
	...
	p18.jumpButton.Parent.Parent:GetPropertyChangedSignal("Enabled"):Connect(function()
		if p18.jumpButton.Parent.Parent.Enabled == false then
			u4();
		end;
	end);
end;
