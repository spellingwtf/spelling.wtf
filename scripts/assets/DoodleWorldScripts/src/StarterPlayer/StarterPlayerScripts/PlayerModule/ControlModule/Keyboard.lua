...
function v2.BindContextActions(p7)
	local function v4(p8, p9, p10)
		if p10.KeyCode == Enum.KeyCode.Left and not _G.InBuilding then
	...
	local function v6(p11, p12, p13)
		if p13.KeyCode == Enum.KeyCode.Right and not _G.InBuilding then
			return Enum.ContextActionResult.Pass;
		end;
	...
	l__ContextActionService__3:BindActionAtPriority("moveForwardAction", function(p14, p15, p16)
	...
	l__ContextActionService__3:BindActionAtPriority("rightArrow", v6, false, p7.CONTROL_ACTION_PRIORITY, Enum.KeyCode.Right);
	l__ContextActionService__3:BindActionAtPriority("leftArrow", v4, false, p7.CONTROL_ACTION_PRIORITY, Enum.KeyCode.Left);
	l__ContextActionService__3:BindActionAtPriority("moveBackwardAction", function(p17, p18, p19)
	...
	l__ContextActionService__3:BindActionAtPriority("moveLeftAction", v4, false, p7.CONTROL_ACTION_PRIORITY, Enum.PlayerActions.CharacterLeft);
	l__ContextActionService__3:BindActionAtPriority("moveRightAction", v6, false, p7.CONTROL_ACTION_PRIORITY, Enum.PlayerActions.CharacterRight);
	l__ContextActionService__3:BindActionAtPriority("jumpAction", function(p20, p21, p22)
		local v10 = p7.jumpEnabled and p21 == Enum.UserInputState.Begin;
		p7.jumpRequested = v10;
		p7:UpdateJump();
		return Enum.ContextActionResult.Pass;
...
function v2.UnbindContextActions(p23)
	...
	l__ContextActionService__3:UnbindAction("rightArrow");
	l__ContextActionService__3:UnbindAction("leftArrow");
...
function v2.ConnectFocusEventListeners(p24)
	...
	p24.textFocusReleasedConn = l__UserInputService__1.TextBoxFocusReleased:Connect(v11);
	p24.textFocusGainedConn = l__UserInputService__1.TextBoxFocused:Connect(function(p25)
		p24.jumpRequested = false;
		p24:UpdateJump();
	end);
	p24.windowFocusReleasedConn = l__UserInputService__1.WindowFocused:Connect(v11);
end;
function v2.DisconnectFocusEventListeners(p26)
	if p26.textFocusReleasedCon then
		p26.textFocusReleasedCon:Disconnect();
		p26.textFocusReleasedCon = nil;
	end;
